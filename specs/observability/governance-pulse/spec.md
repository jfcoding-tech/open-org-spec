...
> The technical identifier for this tool is `governance-pulse` (file paths, command names, and manifest entries use this identifier). The display title is **Governance Pulse**.
...
The adopter declares the output path in their extension. Convention: `governance/observability/governance-pulse.html`.
...
```yaml
artefacts:
  - id: governance-pulse-command
    type: file
    path: {{standard#adopter_command_dir}}/governance-pulse.md
    template: specs/observability/governance-pulse/command.md
    variables:
      - name: model
      ...
      - name: output_path
        ...
        default: governance/observability/governance-pulse.html
      - name: catalogue_path
